...
// CODE BLOCK BEGIN On_Start FRD_RLD_RRD_Open
// On start handler "FRD_RLD_RRD_Open"
void on_start_FRD_RLD_RRD_Open(void) { try { // on start event
s32 FRD = 0;
s32 RLD =0;
s32 RRD = 0;
s32 interior = 0;
...
// CODE BLOCK END On_Start FRD_RLD_RRD_Open
